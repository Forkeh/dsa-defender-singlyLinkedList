...
function createInitialEnemies(number) {
 // create five enemies
...
function loop() {
  ...
  // ****
  let enemyNode = enemies.getFirstNode();
  while (enemyNode != null) {
      const enemy = enemyNode.data;
      
      displayEnemy(enemy);

      enemyNode = enemies.getNextNode(enemyNode);
  }
